...
// }
       $form_demo =  Request::create('/workflow/formdemo', 'POST', [
            ...
            'group' => 'workflow',
            'description' => 'Formulário de parecer final',
            'fields' => '[{ "type": "separator", "label": "Dados do parecer" }, { "name": "titulo", "type": "text", "label": "Título", "required": true, "validation_rule": "max:150", "width": 8 }, [ { "name": "resultado", "type": "select", "label": "Resultado", "required": true, "options": [ "aprovado", "reprovado", "pendente" ] }, { "name": "data_parecer", "type": "date", "label": "Data do parecer", "required": true } ], { "name": "justificativa", "type": "textarea", "label": "Justificativa", "required": true, "validation_rule": "min:20" }, { "name": "anexo", "type": "file", "label": "Anexo", "required": false, "accept": ".pdf,image/*" }]'
        ]);
