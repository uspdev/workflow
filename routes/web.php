...
Route::group(['prefix' => config('uspdev-workflow.prefix'), 'middleware' => ['web']], function () {
    ...
    Route::delete('/definition/remove/{definition}/{version}', [WorkflowController::class, 'destroyDefinition'])->name('workflows.destroyDefinition');
    Route::get('/editdefinition/{definition}/{version}', [WorkflowController::class, 'editDefinition'])->name('workflows.editDefinition');
    ...
    Route::get('/createobject/{definition}/{version}', [WorkflowController::class, 'createObject'])->name('workflows.createObject');
